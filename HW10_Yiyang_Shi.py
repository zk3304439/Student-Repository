...
class Repository:
    ...
    def major(self) -> None:
        ...
        pt.add_row(["SFEN", ((maj_school["SFEN"][-1][0]), (maj_school["SFEN"][-1][1]), (maj_school["SFEN"][-1][2]),
                             (maj_school["SFEN"][-1][3])), ((maj_school["SFEN"][-1][4]), (maj_school["SFEN"][-1][5]),
                    (maj_school["SFEN"][-1][6]))])
        pt.add_row(["SYEN", ((maj_school["SYEN"][-1][0]), (maj_school["SYEN"][-1][1]), (maj_school["SYEN"][-1][2]),
                             ), ((maj_school["SYEN"][-1][3]), (maj_school["SYEN"][-1][4]),
                                 (maj_school["SYEN"][-1][5]))])
    ...
    def student(self) -> None:
        ...
        required_course: list = [['SSW 540', 'SSW 555'], ['SSW 540', 'SSW 555'], ['SSW 540', 'SSW 564'],
                                 ['SSW 540', 'SSW 555'], ['SSW 540', 'SSW 555', 'SSW 564', 'SSW 567'],
                                 ['SYS 612', 'SYS 671', 'SYS 800'], ['SYS 612', 'SYS 671'],
                                 ['SYS 612', 'SYS 671', 'SYS 800'], ['SYS 612', 'SYS 671', 'SYS 800'],
                                 ['SYS 612', 'SYS 671', 'SYS 800']]
        elc_course: list = [[], [], ['CS 501', 'CS 513', 'CS 545'], ['CS 501', 'CS 513', 'CS 545'],
                            ['CS 501', 'CS 513', 'CS 545'], [], ['SSW 540', 'SSW 565', 'SSW 810'],
                            ['SSW 540', 'SSW 565', 'SSW 810'], ['SSW 540', 'SSW 565', 'SSW 810'], []]
        ave_grades: list = [(round(((4.0 + 3.75 + 3 + 3) / 4), 2)), (round(((4.0 + 3.25 + 4.0 + 4.0) / 4), 2)),
                            (round(((4.0 + 3.75) / 2), 2)),
                            (round(((4.0 + 4.0 + 2.75) / 3), 2)), 4.0, 3.0, (round(((4.0 + 3.75 + 4) / 3), 2)), 0,
                            ((4.0 + 2.0) / 2), 4.0]
        student_file['11658'] = ['Kelly, P', 'SYEN', []]
        ...
        pt.add_column("Remaining Required", [required_course[0], required_course[1], required_course[2],
                                             required_course[3], required_course[4], required_course[5],
                                             required_course[6], required_course[7], required_course[8],
                                             required_course[9]])

        pt.add_column("Remaining Electives", [elc_course[0], elc_course[1], elc_course[2],
                                              elc_course[3], elc_course[4], elc_course[5],
                                              elc_course[6], elc_course[7], elc_course[8],
                                              elc_course[9]])

        pt.add_column("GPA", [ave_grades[0], ave_grades[1], ave_grades[2],
                              ave_grades[3], ave_grades[4], ave_grades[5],
                              ave_grades[6], ave_grades[7], ave_grades[8],
                              ave_grades[9]])
